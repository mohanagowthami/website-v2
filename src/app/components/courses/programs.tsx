...
const Programs: React.FC = () => {
  return (
<div className="w-full bg-[#fafdff] sm:px-6 sm:py-6 md:px-12 md:py-12 lg:px-15 lg:py-14 xl:px-24 xl:py-27"id="program">
          <SectionTitle
                mainTitle={true}
  ...
  {programs.map((program, index) => (
    <div key={index} className="p-5 rounded-[20px] border-[#e4e7ec] border-1 bg-[#fff] flex flex-col">

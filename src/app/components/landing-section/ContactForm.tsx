...
//   return (
//     <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4"    id="contact-form">
//       {/* Name Field */}
//       <div>
...
const ContactForm = () => {
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4 animate-form" id="contact-form">
        {/* Name Field */}
        <div>
          <label className="block text-sm font-medium text-gray-700">Name</label>
          <Controller

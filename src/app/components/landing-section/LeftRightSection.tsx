...
//           <h1 className="text-[32px] md:text-[42px] lg:text-[48px] font-bold text-gray-900 leading-tight">
//             Level Up Your Skills and{" "}
//             <span className="text-blue-600">Land Your Dream Job</span>
//           </h1>
//           <p className="text-gray-600 text-[16px] md:text-[18px] leading-7">
//             Master industry-standard skills through expert-led teaching,
//             hands-on training, real-world projects, and personalized mentorship.
//           </p>
//           {/* Statistics Box */}

        ...
        <div className="flex gap-1 sm:gap-2 md:gap-4">
          {tabs.map((tab) => (
            <button
              ...
              className={`relative px-2 sm:px-3 py-1 sm:py-2 text-xs sm:text-sm ${selectedTab === tab.id ? "text-white" : "text-blue-900"
                }`}
            >
              {selectedTab === tab.id && (
                <motion.div
            ...
            <div className="flex flex-col p-2">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`px-4 py-3 text-sm font-medium text-left ${selectedTab === tab.id

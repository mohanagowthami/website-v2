  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-full font-semibold mx-auto ml-15 mr-15 mb-42">
        <h1 className="text-[35px] font-normal flex justify-center text-black mt-20 mb-10">
          {course.title} {/* This will show "Full Stack" from the data */}
        </h1>
        
        {/* Conditionally render tech icons only for Full-Stack */}
        {isFullStack && (
        ...
        <div className="space-y-4">
          {course.weeks.map((week, weekIndex) => (
            <React.Fragment key={weekIndex}>
              {/* Conditionally render Backend heading after Week 12 only for Full-Stack */}
              {isFullStack && weekIndex === week12Index + 1 && (
